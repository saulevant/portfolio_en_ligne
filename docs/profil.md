...
|-----------------|--------------------------------------|-----------------------------|--------------------------------------|-------------------------------|-------------------------------------|-----------------------------------------------|
| [TP OCS Inventory](competences/patrimoine-informatique.md)        |<span style="background-color: #4CAF50; display: inline-block; width: 100%; height: 39px; border-radius: 4px;"></span>                                      |                             |                                      |                               |                                     |                                               |
...
| [Outil de Ticketing](competences/support-assistance.md)        |                                      |<span style="background-color: #4CAF50; display: inline-block; width: 100%; height: 39px; border-radius: 4px;"></span>                             |                                      |                               |                                     |                                               |
